...
const paypalCleanupController = require('./server/controllers/paypalCleanupController');
...
app.post(
  '/api/admin/clean-obsolete-paypal-ids',
  paypalCleanupController.cleanObsoletePayPalIds
);
